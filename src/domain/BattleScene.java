...
public class BattleScene {
    //Метод вызывается при начале боя: сюда мы передаем ссылки на нашего героя и монстра, который встал у него на пути
    ...
    private Boolean makeHit(FantasyCharacter defender, FantasyCharacter attacker, Realm.FightCallback fightCallback) {
        ...
        if (defenderHealth <= 0 && defender instanceof Hero) {
            ...
            //Вызываем callback, что мы проиграли
            ...
            //вызываем callback, что мы победили
